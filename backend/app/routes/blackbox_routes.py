...
#             raise HTTPException(
#                 status_code=422,
#                 detail="API mode requires both 'endpoint' and 'api_key'."
#             )
#     elif payload.mode == "ui":
#         if not payload.ui_url:
#             raise HTTPException(
#                 status_code=422,
#                 detail="UI mode requires 'ui_url'."
#             )
#     else:
...
#     # Save to MongoDB — never store the raw api_key
#     stored = {
#         **result,
