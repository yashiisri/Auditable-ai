...
export default function Report() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#F4F7FB", fontFamily:"'Plus Jakarta Sans','Inter',system-ui,sans-serif", color:"#0B1F33" }}>
      ...
      <div style={{ background:"white", borderBottom:"1px solid #E3EAF3", padding:"0 40px", display:"flex", alignItems:"center", justifyContent:"space-between", height:64, boxShadow:"0 1px 8px rgba(0,51,141,0.06)", position:"sticky", top:0, zIndex:200 }}>
        ...
        <div style={{ display:"flex", gap:10, alignItems:"center" }}>
          <button onClick={handleDownloadPDF} disabled={pdfLoading}
            style={{ padding:"8px 20px", background:pdfLoading?"#F1F5F9":`linear-gradient(135deg,${KPMG_BLUE},${KPMG_MID})`, border:"none", borderRadius:8, color:pdfLoading?KPMG_MID:"white", cursor:pdfLoading?"not-allowed":"pointer", fontSize:13, fontWeight:700, letterSpacing:"0.01em", boxShadow:pdfLoading?"none":`0 4px 14px ${KPMG_BLUE}28` }}>
      ...
      {/* HERO */}
      <div style={{ background:`linear-gradient(135deg,${KPMG_BLUE} 0%,${KPMG_MID} 55%,${KPMG_LIGHT} 100%)`, padding:"36px 40px 0", ...fade(0) }}>
              ...
              return (
                <button key={tab.id} className="rpt-tab"
                  ...
                  {"badge" in tab && (tab as any).badge > 0 && (
                    <span style={{ fontSize:10, fontWeight:800, padding:"1px 7px", borderRadius:10, background:isActive?"#FEE2E2":"rgba(255,255,255,0.18)", color:isActive?"#DC2626":"white", minWidth:18, textAlign:"center" }}>
                      {(tab as any).badge}
                    </span>
                  )}
                </button>
